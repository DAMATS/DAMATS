#!/bin/bash
#
# register Landsat TM product to EOxServer
#
...
RT="LandsatTM:radiance:uint8"
# histogram_to_range.py LT_merged.histogram .1 95
MIN=48,16,12,12,7,0,3
MAX=123,73,85,134,148,129,87
#MIN=24,0,0,0,0,0,0
...
info "building VRT ... "
[ -f "$VRT" ] && rm -fv "$VRT"
gdalbuildvrt "$VRT" -separate "$B1" "$B2" "$B3" "$B4" "$B5" "$B6" "$B7"
